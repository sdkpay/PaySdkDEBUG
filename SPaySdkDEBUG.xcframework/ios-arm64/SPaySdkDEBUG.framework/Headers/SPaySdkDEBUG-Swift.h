...
#ifndef SPAYSDKDEBUG_SWIFT_H
#define SPAYSDKDEBUG_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SPaySdkDEBUG",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
IB_DESIGNABLE
SWIFT_CLASS("_TtC12SPaySdkDEBUG9SBPButton")
...
SWIFT_CLASS("_TtC12SPaySdkDEBUG7SPError")
...
@class NSURL;
SWIFT_CLASS("_TtC12SPaySdkDEBUG4SPay")
...
@interface SPay (SWIFT_EXTENSION(SPaySdkDEBUG))
...
typedef SWIFT_ENUM_NAMED(NSInteger, SPayMethodObjc, "SPayMethodObjc", open) {
  ...
  SPayMethodObjcWithPartPay = 4,
  SPayMethodObjcWithBinding = 5,
  SPayMethodObjcWithPhoneNumber = 6,
};
...
SWIFT_CLASS("_TtC12SPaySdkDEBUG15SPaymentRequest")
...
enum SPaymentToolObjc : NSInteger;
SWIFT_CLASS_NAMED("SPaymentRequestObjc")
@interface SPaymentRequestObjc : NSObject
- (nonnull instancetype)initWithApiKey:(NSString * _Nonnull)apiKey bankInvoiceId:(NSString * _Nonnull)bankInvoiceId orderNumber:(NSString * _Nonnull)orderNumber merchantLogin:(NSString * _Nonnull)merchantLogin redirectUri:(NSString * _Nonnull)redirectUri bindingId:(NSString * _Nullable)bindingId paymentTool:(enum SPaymentToolObjc)paymentTool OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM_NAMED(NSInteger, SPaymentToolObjc, "SPaymentTool", open) {
  SPaymentToolObjcCards = 0,
  SPaymentToolObjcPaymentAccounts = 1,
};
